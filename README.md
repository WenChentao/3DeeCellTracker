...
## Update:
### 2021.03.29
The tracking speed of our program has been remarkably reduced using vectorization.
See an example in the jupyter notebook: [Single mode/worm1](Tracking_notebooks/single_mode_worm1.ipynb)
