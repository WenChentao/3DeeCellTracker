...
class CoordsToImageTransformer:
    ...
    def save_merged_labels(self, corrected_labels_image: ndarray, images_path: str | dict, t: int):
        ...
        merged_labels.save(str(self.results_folder / TRACK_RESULTS / MERGED_LABELS / ("merged_labels_t%05d.png" % t)))
        merged_labels_xz.save(
            str(self.results_folder / TRACK_RESULTS / MERGED_LABELS_XZ / ("merged_labels_xz_t%05d.png" % t)))
...
def save_tracked_labels(results_folder: Path, labels_xyz: ndarray, t: int, use_8_bit: bool):
    ...
    for z in range(1, labels_xyz.shape[2] + 1):
        ...
        Image.fromarray(img2d).save(str(tracked_labels_path / ("track_results_t%05i_z%05i.tif" % (t, z))),
